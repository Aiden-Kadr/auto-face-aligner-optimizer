...
def get_resource_path(relative_path):
    """Определяет путь к ресурсам внутри упакованного EXE."""
    try:
...
if __name__ == "__main__":
    ...
    if IMAGE_PATH:
        MODEL_PATH = get_resource_path("shape_predictor_68_face_landmarks.dat")  # Учитываем динамический путь
        OUTPUT_WIDTH = 800
        OUTPUT_HEIGHT = 600
    ...
    input("\nПрограмма завершена. Нажмите Enter, чтобы выйти...")
